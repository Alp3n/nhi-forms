...
const PatientDetails = ({ item }) => {
  return (
    <Modal title='Szczegóły Pacjenta'>
      <Grid>
        <Detail title='Utworzono:' data={item['Sygnatura czasowa']} />
        <Detail
          title='Inicjały pacjenta:'
          data={item['1. Inicjały pacjenta:']}
        />
        ...
        <Detail
          ...
          data={
            item['9. Czy wykonywał badania nasienia w okresie około-COVID?']
          }
        />
        <Detail
